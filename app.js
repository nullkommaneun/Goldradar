...
// Gruppierung: Geld & Zinsen, Märkte & Risiko, Konjunktur & Rohstoffe
const GROUPS = {
...
// Serienaufbereitung + Deltas (stabile Version aus letztem Fix)
...
(async function(){
  try{
    ...
    // Historischer Vergleich (unverändert – bereits robust)
