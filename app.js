...
(async function(){
  try{
    ...
    // Stage 1: schnelle UI-Initialisierung
    renderSystemFromPreflight(); // falls preflight schon fertig
    ...
    // Bewertung & schnelle Bereiche rendern (Treiber + Forecast)
    ...
    function driverItem(key){
      ...
      el.innerHTML = `
        <div class="ampel">
          ...
          <span class="info" title="${tip}" aria-label="${tip}">i</span>
        </div>
    ...
    // Stage 2 (idle): Historischer Vergleich (teurer) wird nachrangig berechnet
